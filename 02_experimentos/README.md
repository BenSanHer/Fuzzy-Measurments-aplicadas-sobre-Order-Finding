...
- `01_experimentos/`: notebooks separados por objetivo experimental. (En proceso de reconstrucción de los avances ya realizados)
- `02_direcciones_investigacion/`: problemas abiertos y líneas de trabajo activas. (La información en celdas md)
